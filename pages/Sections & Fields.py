...
def display_speed_position_and_navigation():
    ...
    with col1:
        ...
        st.number_input("Latitude Degree", min_value=-90, max_value=90, step=1)
        st.number_input("Latitude Minutes", min_value=0.0, max_value=59.99, step=0.01, format="%.2f")
    ...
    with col2:
        ...
        st.number_input("Longitude Degree", min_value=-180, max_value=180, step=1)
        st.number_input("Longitude Minutes", min_value=0.0, max_value=59.99, step=0.01, format="%.2f")
    ...
    with col3:
        ...
        st.number_input("True Heading (°)", min_value=0, max_value=359, step=1)

...
def engine_tab():
    ...
    with col2:
        st.number_input("No Of Operations", min_value=0, step=1, key="me_fo_no_of_operations")
        st.number_input("No Of Operations", min_value=0, step=1, key="me_lo_no_of_operations")
    ...
    st.text("Turbocharger")
    col1, col2, col3 = st.columns(3)
    with col1:
        st.number_input("No.1 T/C RPM", min_value=0.0, step=0.1, key="no1_tc_rpm")
        st.number_input("No.1 T/C Exh Gas Temp In (°C)", min_value=0.0, step=0.1, key="no1_tc_exh_gas_temp_in")
        st.number_input("No.1 T/C Exh Gas Temp Out (°C)", min_value=0.0, step=0.1, key="no1_tc_exh_gas_temp_out")
        st.number_input("No.1 Bearing Oil Temp In (°C)", min_value=0.0, step=0.1, key="no1_bearing_oil_temp_in")
        st.number_input("No.1 Bearing Oil Temp Out (°C)", min_value=0.0, step=0.1, key="no1_bearing_oil_temp_out")
        st.number_input("No.1 Bearing oil Pressure (bar)", min_value=0.0, step=0.1, key="no1_bearing_oil_pressure")
        st.number_input("No.1 TC Suction Pressure drop (bar)", min_value=0.0, step=0.1, key="no1_tc_suction_pressure_drop")
    with col2:
        st.number_input("No.2 T/C RPM", min_value=0.0, step=0.1, key="no2_tc_rpm")
        st.number_input("No.2 T/C Exh Gas Temp In (°C)", min_value=0.0, step=0.1, key="no2_tc_exh_gas_temp_in")
        st.number_input("No.2 T/C Exh Gas Temp Out (°C)", min_value=0.0, step=0.1, key="no2_tc_exh_gas_temp_out")
        st.number_input("No.2 Bearing Oil Temp In (°C)", min_value=0.0, step=0.1, key="no2_bearing_oil_temp_in")
        st.number_input("No.2 Bearing Oil Temp Out (°C)", min_value=0.0, step=0.1, key="no2_bearing_oil_temp_out")
        st.number_input("No.2 Bearing oil Pressure (bar)", min_value=0.0, step=0.1, key="no2_bearing_oil_pressure")
        st.number_input("No.2 TC Suction Pressure drop (bar)", min_value=0.0, step=0.1, key="no2_tc_suction_pressure_drop")
    with col3:
        st.number_input("No.3 T/C RPM", min_value=0.0, step=0.1, key="no3_tc_rpm")
        st.number_input("No.3 T/C Exh Gas Temp In (°C)", min_value=0.0, step=0.1, key="no3_tc_exh_gas_temp_in")
        st.number_input("No.3 T/C Exh Gas Temp Out (°C)", min_value=0.0, step=0.1, key="no3_tc_exh_gas_temp_out")
        st.number_input("No.3 Bearing Oil Temp In (°C)", min_value=0.0, step=0.1, key="no3_bearing_oil_temp_in")
        st.number_input("No.3 Bearing Oil Temp Out (°C)", min_value=0.0, step=0.1, key="no3_bearing_oil_temp_out")
        st.number_input("No.3 Bearing oil Pressure (bar)", min_value=0.0, step=0.1, key="no3_bearing_oil_pressure")
        st.number_input("No.3 TC Suction Pressure drop (bar)", min_value=0.0, step=0.1, key="no3_tc_suction_pressure_drop")

    # Auxiliary Engines Section
    st.subheader("Auxiliary Engines")
    col1, col2 = st.columns(2)
    with col1:
        st.number_input("A/E No.1 Generator Load (kw)", min_value=0, step=1, key="ae_no1_generator_load")
        st.number_input("A/E No.2 Generator Load (kw)", min_value=0, step=1, key="ae_no2_generator_load")
        st.number_input("A/E No.3 Generator Load (kw)", min_value=0, step=1, key="ae_no3_generator_load")
        st.number_input("A/E No.4 Generator Load (kw)", min_value=0, step=1, key="ae_no4_generator_load")
    with col2:
        st.number_input("A/E No.1 Generator Hours of Operation (hrs)", min_value=0.0, step=0.1, key="ae_no1_generator_hours")
        st.number_input("A/E No.2 Generator Hours of Operation (hrs)", min_value=0.0, step=0.1, key="ae_no2_generator_hours")
        st.number_input("A/E No.3 Generator Hours of Operation (hrs)", min_value=0.0, step=0.1, key="ae_no3_generator_hours")
        st.number_input("A/E No.4 Generator Hours of Operation (hrs)", min_value=0.0, step=0.1, key="ae_no4_generator_hours")
    ...
    with col2:
        ...
        st.number_input("Days", min_value=0, step=1, key="last_landing_bilge_water_days")
        st.date_input("Last landing of Sludge", datetime.now(), key="last_landing_sludge_date")
        st.number_input("Days", min_value=0, step=1, key="last_landing_sludge_days")
    ...
    st.subheader("Detailed Fuel Consumption (mT)")
    consumptions_data = {
        "Oil Type": [
